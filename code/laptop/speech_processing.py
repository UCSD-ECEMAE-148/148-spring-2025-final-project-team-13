...
SAFETY_PREFIX = "go go go"  # words that have to be spoken before any action is taken (set to "", None or False if not desired)

TIME_TO_LISTEN = 15  # time to listen (will then stop listening to process); in seconds
...
COMMAND_VALUES = {
    ...
    "left": (0.5*MAX_LEFT_ANGLE, DEFAULT_THROTTLE, DEFAULT_TIMEOUT),
    "right": (0.5*MAX_RIGHT_ANGLE, DEFAULT_THROTTLE, DEFAULT_TIMEOUT),
